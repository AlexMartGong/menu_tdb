...
Public Class formCarreraBuscar
    Dim adCon As MySqlConnection
    Private cm As MySqlCommand
    Private da As MySqlDataAdapter
    Private Sub formCarreraBuscar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub txtFiltrar_TextChanged(sender As Object, e As EventArgs) Handles txtFiltrar.TextChanged
        ...
        Try
            Dim sentencia As String = "call spBuscarCarreraPorNombre('" & txtFiltrar.Text & "')"
            adCon.Open()
